...
from datasets.grouped_sampler import FolderGroupedBatchSampler
...
def trainer_psma(args, model, snapshot_path, multimask_output, low_res):
    ...
    train_batch_sampler = FolderGroupedBatchSampler(
        train_dataset,
        batch_size=batch_size,
        drop_last=False,
        shuffle=True,
        shuffle_within_folder=False,
        random_drop_within_folder=True,
        seed=args.seed,
    )
    ...
    val_batch_sampler = FolderGroupedBatchSampler(
        val_dataset,
        batch_size=batch_size,
        drop_last=False,
        shuffle=False,
    ...
    save_interval = int(0.2 * max_epoch)
